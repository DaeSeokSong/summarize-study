...
//	bool isColor = true;
//	VideoWriter outputVideo("D:\\example\\dataset\\video\\trackingRect_CamShift.avi", fourcc, fps, size, isColor);
...
//			RotatedRect trackBox = CamShift(backProject, trackingWindow, criteria);
//			//Point pt1 = Point(trackingWindow.x, trackingWindow.y);
//			//Point pt2 = Point(pt1.x + trackingWindow.width, pt1.y + trackingWindow.y);
//			//rectangle(dstImg, pt1, pt2, Scalar(0, 0, 255), 2);
//			ellipse(dstImg, trackBox, Scalar(255, 0, 0), 2);
//			Point2f rectPoint[4];
//			trackBox.points(rectPoint);
//			for (int i = 0; i < 4; i++) line(dstImg, rectPoint[i], rectPoint[(i + 1) % 4], Scalar(0, 0, 255), 2);
//		}
//
